<template>
  <div class="tile" @click="toRoute">
    <div class="main-container">
      <div class="main-container__row">
        <div class="main-container__row-left">
          <img class="view-img-resize" src="~/assets/icons/completed.svg" />
    ...
    <div class="completed">
      <div>
        <img class="img" src="~/assets/icons/check-square.svg" />
      </div>
    </div>
  </div>
</template>
...
@import "~/assets/scss/components/training-plan/completed-card";
</style>
